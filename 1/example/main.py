...
def validate(val_loader, model, criterion, num_classes, debug=False, flip=True):
    ...
    with torch.no_grad():
        ...
        for i, (input,meta1) in enumerate(val_loader):
            ...
            preds = final_preds(score_map, meta1['center'], meta1['scale'], [64, 64])
            for n in range(score_map.size(0)):
                predictions[meta1['index'][n], :, :] = preds[n, :, :]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='mpii',
                        ...
                        help='Datasets: ' +
                            ' | '.join(dataset_names) +
                            ' (default: mpii)')
    parser.add_argument('--image-path', default=r'C:\Users\cityscience\Desktop\1\data\mpii\images', type=str,
                        help='path to images')
    parser.add_argument('--anno-path', default=r'C:\Users\cityscience\Desktop\1\data\mpii\mpii_annotations.json', type=str,
